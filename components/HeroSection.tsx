...
const HeroSection = () => {
  ...
  return (
    <section className="bg-[#0B0B0B] pt-32 pb-24 min-h-[90vh] relative overflow-hidden rounded-b-[40px]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-20">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            Helping founders bring their ideas to life, attract early users, and iterate to product-market fit in just few weeks.
          </p>
          <Link
